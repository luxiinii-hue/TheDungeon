...
# Map path rendering
MAP_PATH_VISITED_COLOR = (100, 90, 80)
MAP_PATH_AVAILABLE_COLOR = (180, 160, 120)
MAP_PATH_LOCKED_COLOR = (50, 45, 55)
MAP_PATH_OUTLINE_COLOR = (25, 22, 30)
MAP_PATH_WIDTH = 3
MAP_PATH_GLOW_MIN = 40
MAP_PATH_GLOW_MAX = 120
MAP_PATH_CURVE_SEGMENTS = 24
